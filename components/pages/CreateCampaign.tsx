...
import { connectMetamask, createCampaign } from '@/web3/useCases';
            ...
            <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
                <div className="flex flex-wrap gap-[40px]">
                    <FormField
                        ...
                        inputType="text"
                        value={form.name}
                        handleChange={(e) => handleFormFieldChange('name', e)} isTextArea={false} />
                    <FormField
                ...
                <div className="w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]">
                    ...
                    <h4 className="font-epilogue font-bold text-[25px] text-white ml-[20px]">Campaigns are funded by the community</h4>
                </div>
